const DRUGS = [
  ...
  },
  {
    ...
    classes: ["Class II Antiarrhythmic", "Non-Selective Beta-Blocker"],
    source: "Mixed",
    moa: [
      {
  ...
  },
  {
    ...
    classes: ["Vitamin", "Nutritional Supplement"],
    source: "Mixed",
    moa: [
      {
  ...
  },
  {
    ...
    moa: [
      {
        brief: 'Directly stimulates <span class="hl hl--alpha">V1 receptors</span> on vascular smooth muscle <span class="moa-arrow">→</span> phospholipase C activation <span class="moa-arrow">→</span> intracellular calcium release <span class="moa-arrow">→</span> <strong>vasoconstriction independent of the adrenergic system</strong>. This is the primary therapeutic effect in shock.',
        target: { name: "V1 receptors (vascular)", action: "agonist", result: "Vasoconstriction, ↑ SVR", system: "other" }
      },
      {
        brief: 'Stimulates <span class="hl hl--beta">V2 receptors</span> in the renal collecting duct <span class="moa-arrow">→</span> aquaporin-2 insertion <span class="moa-arrow">→</span> <strong>water reabsorption (antidiuresis)</strong>. This is the endogenous ADH function.',
  ...
  },
  {
    ...
    moa: [
      {
        brief: 'Competitively blocks <span class="hl hl--beta">acetylcholine</span> at nicotinic receptors on the motor end plate <span class="moa-arrow">→</span> prevents depolarization of skeletal muscle <span class="moa-arrow">→</span> <strong>flaccid paralysis</strong>. Structurally similar to pancuronium but without vagolytic (heart rate–increasing) effects.',
        target: { name: "Nicotinic acetylcholine receptors (NMJ)", action: "antagonist", result: "Skeletal muscle paralysis", system: "cholinergic" }
      }
    ],
    indications: [
  ...
  },
  {
    ...
    moa: [
      {
        brief: 'Blocks <span class="hl hl--beta">L-type calcium channels</span> in the SA and AV nodes <span class="moa-arrow">→</span> slows conduction velocity and prolongs the AV node refractory period <span class="moa-arrow">→</span> <strong>interrupts reentrant circuits</strong> <span class="moa-arrow">→</span> terminates SVT or controls ventricular rate in AF/AFL.',
        target: { name: "L-type Ca²⁺ channels (SA/AV node)", action: "blocker", result: "↓ AV conduction, ↑ AV refractory period", system: "ion-channel" }
      },
      {
        brief: 'Also blocks L-type calcium channels on <span class="hl hl--beta">vascular smooth muscle</span> <span class="moa-arrow">→</span> vasodilation <span class="moa-arrow">→</span> <strong>reduced afterload</strong>. Has negative inotropic effect — reduces myocardial contractility.',
  ...
  },
  {
    ...
    moa: [
      {
        brief: 'Potentiates <span class="hl hl--beta">GABA-A receptors</span> in the CNS <span class="moa-arrow">→</span> prolongs chloride channel opening <span class="moa-arrow">→</span> neuronal hyperpolarization <span class="moa-arrow">→</span> <strong>rapid sedation, amnesia, and unconsciousness</strong>. Also reduces cerebral metabolic rate and intracranial pressure.',
  ...
  },
  {
    ...
    moa: [
      {
        brief: 'Blocks <span class="hl hl--beta">fast sodium channels</span> (phase 0) <span class="moa-arrow">→</span> slows conduction velocity through atrial, ventricular, and accessory pathway tissue <span class="moa-arrow">→</span> <strong>increases refractoriness and prolongs the action potential</strong>. Also has some potassium channel blocking activity (prolongs repolarization → ↑ QT).',
  ...
  },
  {
    ...
    moa: [
      {
        brief: 'Blocks <span class="hl hl--beta">H1 receptors</span> centrally and peripherally <span class="moa-arrow">→</span> antihistamine and sedative effects. Also blocks <span class="hl hl--beta">D2 receptors</span> in the chemoreceptor trigger zone and vestibular apparatus <span class="moa-arrow">→</span> <strong>potent antiemetic and anti-motion sickness effects</strong>. Additional anticholinergic (muscarinic) and α-adrenergic blocking activity.',
  ...
  },
  {
    ...
    category: ["Toxicology"],
    classes: ["Antidote", "Cholinesterase Reactivator", "Oxime"],
    source: "Mixed",
    moa: [
      {
        brief: 'Binds to the anionic site of organophosphate-inhibited <span class="hl hl--beta">acetylcholinesterase</span> <span class="moa-arrow">→</span> displaces the organophosphate from the enzyme’s serine site <span class="moa-arrow">→</span> <strong>reactivates AChE</strong> <span class="moa-arrow">→</span> restores acetylcholine breakdown at nicotinic junctions. The OP-pralidoxime complex is then excreted renally.',
  ...
  },
  {
    ...
    moa: [
      {
        brief: 'Replaces intracellular and extracellular <span class="hl hl--beta">potassium deficit</span> <span class="moa-arrow">→</span> restores the normal transmembrane electrochemical gradient <span class="moa-arrow">→</span> <strong>normalizes cardiac conduction, skeletal muscle contractility, and nerve impulse transmission</strong>. Potassium is the primary intracellular cation; even small changes in extracellular K⁺ (normal 3.5–5.0 mEq/L) dramatically affect membrane excitability.',
  ...
  },
  {
    ...
    moa: [
      {
        brief: 'Binds <span class="hl hl--beta">oxytocin receptors</span> on uterine myometrial cells <span class="moa-arrow">→</span> stimulates prostaglandin production and increases intracellular calcium <span class="moa-arrow">→</span> <strong>rhythmic contractions of the upper uterine segment</strong> <span class="moa-arrow">→</span> mechanically compresses spiral arteries that are devoid of their own musculature <span class="moa-arrow">→</span> hemostasis.',
  ...
  },
  {
    ...
    moa: [
      {
        brief: 'Competitively blocks <span class="hl hl--beta">H1 receptors</span> peripherally (antihistamine/antipruritic) and centrally (sedation). Also suppresses subcortical CNS activity <span class="moa-arrow">→</span> <strong>anxiolytic effect without cortical depression</strong>. Additional anticholinergic activity provides antiemetic and antispasmodic properties. Metabolized to <strong>cetirizine</strong> (Zyrtec), an active second-generation antihistamine.',
  ...
  },
  {
    ...
    tradeNames: ["Cyanokit"],
    category: ["Toxicology"],
    classes: ["Antidote", "Cyanide Chelator", "Vitamin B12a"],
    source: "Mixed",
    moa: [
      {
  ...
  },
  {
    ...
    category: ["Airway & Respiratory"],
    classes: ["Short-Acting Beta-2 Agonist (SABA)", "Bronchodilator"],
    source: "Mixed",
    moa: [
      {
  ...
  },
  {
    ...
    category: ["Toxicology"],
    classes: ["Antidote", "GI Decontaminant", "Adsorbent"],
    source: "Mixed",
    moa: [
      {
  ...
  },
  {
    ...
    category: ["Cardiovascular"],
    classes: ["Antiarrhythmic", "Purine Nucleoside"],
    source: "Mixed",
    moa: [
      {
  ...
  },
  {
    ...
    tradeNames: ["Dobutrex"],
    category: ["Cardiovascular"],
    classes: ["Sympathomimetic", "Inotropic Agent", "Catecholamine"],
    source: "StatPearls",
    moa: [
      {
  ...
  },
  {
    ...
    tradeNames: ["Cardene"],
    category: ["Cardiovascular"],
    classes: ["Calcium Channel Blocker (DHP)", "Antihypertensive"],
    source: "StatPearls",
    moa: [
      {
  ...
  },
  {
    ...
    category: ["Cardiovascular"],
    classes: ["Beta Blocker (β-1 Selective)"],
    source: "NASEMSO 2022 v3.0",
    moa: [
      {
  ...
  },
  {
    ...
    classes: ["Alpha/Beta Blocker", "Antihypertensive"],
    source: "NASEMSO 2022 v3.0",
    moa: [
      {
