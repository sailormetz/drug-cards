const DRUGS = [
  ...
  ,{
    ...
    moaTiered: [
      { tier: "Low",  range: "2–5 mcg/kg/min",  target: "Renal", brief: 'D1 receptors → vasodilation of renal and splanchnic (gut) vessels → increases kidney and intestinal blood flow' },
      { tier: "Mod",  range: "5–10 mcg/kg/min", target: "Cardiac", brief: '<span class="hl hl--beta">β-1</span> receptors → increases heart contractility and heart rate. Cardiac output rises.' },
      { tier: "High", range: ">10 mcg/kg/min",  target: "Vasopressor", brief: '<span class="hl hl--alpha">α-1</span> receptors → widespread vasoconstriction → SVR and blood pressure rise. Increased afterload — heart works harder against tighter vessels.' }
    ],
